...
While the Big Data industry is growing rapidly, it is still in its early stages as it relates to a common understanding and identification of the complete skillset needed to be a top-notch data scientist in the industry. While being a mathematics major provides a great foundation for what's required to be a good data scientist, we discuss what else is necessary.
